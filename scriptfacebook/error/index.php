    ...
    <body>
        <div class="container">
            ...
            <section class="contact-info">
                ...
                <a href="mailto:webmaster@<?php echo $url;?>" target="_blank" rel="noopener noreferrer" title="Click this link to contact the host" id="dynamicProviderLink">
                    webmaster@<?php echo $url;?>
                </a>
            </section>
        ...
        <footer>
            <div class="container">
                <a href="https://cpanel.com/?utm_source=cpanelwhm&amp;utm_medium=cplogo&amp;utm_content=logolink&amp;utm_campaign=cpanelwhmreferral" target="cpanel" title="cPanel, L.L.C.">
                    <img src="/img-sys/powered_by_cpanel.svg" height="20" alt="cPanel, L.L.C.">
                    <div class="copyright">Copyright © 2020 cPanel, L.L.C.</div>
                </a>
            </div>
        </footer>
</body>
